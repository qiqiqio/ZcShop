...
public class OrderItemAdapter extends RecyclerView.Adapter<OrderItemAdapter.ViewHolder> implements View.OnClickListener {
    ...
    public OrderItemAdapter(Context context, List<Goods> data) {
        this.data = data;
